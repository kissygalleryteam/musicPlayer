...
kg/musicplayer/2.0.1/lib/audio
kg/musicplayer/2.0.1/lib/flash
kg/musicplayer/2.0.1/index
 ...
 * @module musicPlayer
 **/
KISSY.add('kg/musicplayer/2.0.1/lib/audio',function (S, Node) {
 ...
 * @module musicPlayer
 **/
KISSY.add('kg/musicplayer/2.0.1/lib/flash',function (S, Node, SWF) {
    var MusicPlayer,
        swf,
        defaultConfig,
        _obj;
 ...
 * @module musicPlayer
 **/
KISSY.add('kg/musicplayer/2.0.1/index',function (S, Node,Base,AUDIO,FLASH) {
    var _this;
    /**
     *
     * @class MusicPlayer
...
}, {requires:['node', 'base', "./lib/audio", "./lib/flash"]});
